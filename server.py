...
Important:
- Use the supplied conversation history for current-conversation context.
- Use saved memories only when they are actually supplied above.
